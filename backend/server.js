...
app.use(cors({origin:['http://intern.enlighttechz.in', 'https://intern.enlighttechz.in/', 'https://et-internship-portal.vercel.app/', 'http://localhost:5173/', 'http://localhost:5173']}));
